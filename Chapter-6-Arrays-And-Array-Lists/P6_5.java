...
public class P6_5 {
	public static void main(String[] args) {
		...
		if(index < numbers.length && index >= 0) removeAtIndex(index, numbers);
		else System.out.println("There is no index with the number " + index + ".");
	}
	...
	public static void arrayAndIndex(int[] inArray) {
		...
		System.out.print("\nIndex: ");
		for(int i = 0; i < inArray.length; i++) System.out.print(i + "  ");
	}
}
